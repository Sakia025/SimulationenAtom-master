...
def main():
	...
	#print('point correctly tested as inside =',true_positive_count/positive_count)
	#print('point incorrectly tested as inside =', false_positive_count/positive_count)
	#print('point correctly tested as outside =', true_negative_count/negative_count)
	#print('point incorrectly tested as outside =', false_negative_count/negative_count)
